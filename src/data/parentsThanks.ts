...
export const parentsThanks: {
  ...
  title: {
    ru: "Спасибо за Леру",
    en: "Thank you for Valeriia",
    de: "Danke für Valeriia"
  },
  subtitle: {
  ...
  recipient: {
    ru: "Родителям Леры",
    en: "For Valeriia's parents",
    de: "Für Valeriias Eltern"
  },
  openButton: {
    ru: "Показать письмо",
    en: "Show the letter",
  ...
  letter: {
    ru: `Уважаемые Виталий Сергеевич и Елена Анатольевна,

Хочется отдельно поблагодарить вас за труд, время, любовь и тепло, которые вы вложили и продолжаете вкладывать в такую замечательную девушку.
